...
)
{
	...
	std::cout << std::endl;
	std::cout << "capture width: " << cw << std::endl;
	std::cout << "capture height: " << ch << std::endl;
...
/*JNIEXPORT void JNICALL Java_hypermedia_video_OpenCV_info
(
 JNIEnv * env, jobject obj,
 jint property
)
