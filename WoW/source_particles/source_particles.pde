...
void setup(){
  ...
  try {
    glParticle = TextureIO.newTexture(new File("/home/mistercrunch/Code/Processing/particle.png"), true);  
  }
  catch (IOException e) {    
  ...
  try {
    glEmitter = TextureIO.newTexture(new File("/home/mistercrunch/Code/Processing/particle.png"), true);  
  }
  catch (IOException e) {    
    println("Texture file is missing");
    exit();  // or handle it some other way
