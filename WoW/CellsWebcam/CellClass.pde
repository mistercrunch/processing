...
class Cell
{
  ...
  void Blend()
  {
    ...
    //v2dCur.Distance(v2dOrigin)
    
    blend(pImg, 0,0, cellSize, cellSize, (int)v2dCur.x, (int)v2dCur.y, cellSize, cellSize, BLEND);   
  ...
  void AdjustVel()
  {
    ...
    if(mousePressed)
    {  
      mouseDistance=pow(mouseDistance, 0.5);
      v2dMouseDist.Div(mouseDistance*25);
      if (mouseButton==LEFT)
